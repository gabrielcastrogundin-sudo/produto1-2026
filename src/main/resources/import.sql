...
insert into tb_product (nome,created_at) values ('Livros', NOW());
insert into tb_product (nome,created_at) values ('Canecas', NOW());
insert into tb_product (nome,created_at) values ('Lapis', NOW());
insert into tb_product (nome,created_at) values ('Borrachas', NOW());
insert into tb_product (nome,created_at) values ('Isqueiro', NOW());